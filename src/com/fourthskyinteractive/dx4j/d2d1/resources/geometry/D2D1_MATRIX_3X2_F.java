 ...
 */
@Library("d2d1") 
public class D2D1_MATRIX_3X2_F extends StructObject {
	public D2D1_MATRIX_3X2_F() {
		super();
	}
	public D2D1_MATRIX_3X2_F(Pointer<? extends StructObject> pointer) {
		super(pointer);
	}
	@Field(0) 
	public float _11() {
	...
	@Field(0) 
	public D2D1_MATRIX_3X2_F _11(float _11) {
	...
	@Field(1) 
	public D2D1_MATRIX_3X2_F _12(float _12) {
	...
	@Field(2) 
	public D2D1_MATRIX_3X2_F _21(float _21) {
	...
	@Field(3) 
	public D2D1_MATRIX_3X2_F _22(float _22) {
	...
	@Field(4) 
	public D2D1_MATRIX_3X2_F _31(float _31) {
	...
	@Field(5) 
	public D2D1_MATRIX_3X2_F _32(float _32) {
		this.io.setFloatField(this, 5, _32);
		return this;
	}
	
	public static D2D1_MATRIX_3X2_F Identity() {
		D2D1_MATRIX_3X2_F m = new D2D1_MATRIX_3X2_F();
		m._11(1.f)._12(0.f)._21(0.f)._22(1.f)._31(0.f)._32(0.f);		
		return m;
	}
}
