 ...
 */
@Library("d2d1") 
public class D2D1_RECT_F extends StructObject {
	public D2D1_RECT_F() {
		super();
	}
	public D2D1_RECT_F(Pointer<? extends StructObject> pointer) {
		super(pointer);
	}
	@Field(0) 
	public float left() {
	...
	@Field(0) 
	public D2D1_RECT_F left(float left) {
	...
	@Field(1) 
	public D2D1_RECT_F top(float top) {
	...
	@Field(2) 
	public D2D1_RECT_F right(float right) {
	...
	@Field(3) 
	public D2D1_RECT_F bottom(float bottom) {
