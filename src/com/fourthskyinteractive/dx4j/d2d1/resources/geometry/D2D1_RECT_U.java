 ...
 */
@Library("d2d1") 
public class D2D1_RECT_U extends StructObject {
	public D2D1_RECT_U() {
		super();
	}
	...
	/// C type : UINT32
	@Field(0) 
	public D2D1_RECT_U left(int left) {
	...
	/// C type : UINT32
	@Field(1) 
	public D2D1_RECT_U top(int top) {
	...
	/// C type : UINT32
	@Field(2) 
	public D2D1_RECT_U right(int right) {
	...
	/// C type : UINT32
	@Field(3) 
	public D2D1_RECT_U bottom(int bottom) {
