...
import com.fourthskyinteractive.dx4j.d2d1.D2d1Library.D2D1_BITMAP_INTERPOLATION_MODE;
import com.fourthskyinteractive.dx4j.d2d1.D2d1Library.D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS;
import com.fourthskyinteractive.dx4j.d2d1.D2d1Library.D2D1_DRAW_TEXT_OPTIONS;
...
import com.fourthskyinteractive.dx4j.d2d1.D2d1Library.D2D1_OPACITY_MASK_CONTENT;
import com.fourthskyinteractive.dx4j.d2d1.D2d1Library.D2D1_TEXT_ANTIALIAS_MODE;
import com.fourthskyinteractive.dx4j.dwrite.DWRITE_GLYPH_RUN;
import com.fourthskyinteractive.dx4j.dwrite.DWriteLibrary.DWRITE_MEASURING_MODE;
...
//	}
	...
	@Virtual(11)
	public native void DrawLine(D2D1_POINT_2F point0, D2D1_POINT_2F point1, Pointer<ID2D1Brush> brush, float strokeWidth, Pointer<ID2D1StrokeStyle> strokeStyle);
	
	@Virtual(12)
	public native void DrawRectangle(Pointer<D2D1_RECT_F> rect, Pointer<ID2D1Brush> brush, float strokeWidth, Pointer<ID2D1StrokeStyle> strokeStyle);
	
	@Virtual(13)
	public native void FillRectangle(Pointer<D2D1_RECT_F> rect, Pointer<ID2D1Brush> brush);
	
	@Virtual(14)
	public native void DrawRoundedRectangle(Pointer<D2D1_ROUNDED_RECT> roundedRect, Pointer<ID2D1Brush> brush, float strokeWidth, Pointer<ID2D1StrokeStyle>strokeStyle);
	
	@Virtual(15)
	public native void FillRoundedRectangle(Pointer<D2D1_ROUNDED_RECT> roundedRect, Pointer<ID2D1Brush> brush);
	
	@Virtual(16)
	public native void DrawEllipse(Pointer<D2D1_ELLIPSE> ellipse, Pointer<ID2D1Brush> brush, float strokeWidth, Pointer<ID2D1StrokeStyle> strokeStyle);
	
	@Virtual(17)
	public native void FillEllipse(Pointer<D2D1_ELLIPSE> ellipse, Pointer<ID2D1Brush> brush);
	
	@Virtual(18)
	public native void DrawGeometry(Pointer<ID2D1Geometry> geometry, Pointer<ID2D1Brush> brush, float strokeWidth, Pointer<ID2D1StrokeStyle> strokeStyle);
	 ...
	 */
	@Virtual(19)
	public native void FillGeometry(Pointer<ID2D1Geometry> geometry, Pointer<ID2D1Brush> brush, Pointer<ID2D1Brush> opacityBrush);
	 ...
	 */
	@Virtual(20)
	public native void FillMesh(Pointer<ID2D1Mesh> mesh, Pointer<ID2D1Brush> brush);
	
	@Virtual(21)
	public native void FillOpacityMask(Pointer<ID2D1Bitmap> opacityMask, Pointer<ID2D1Brush> brush, ValuedEnum<D2D1_OPACITY_MASK_CONTENT> content, Pointer<D2D1_RECT_F> destinationRectangle, Pointer<D2D1_RECT_F> sourceRectangle);
	 ...
	 */
	@Virtual(24)
	public native void DrawTextLayout(D2D1_POINT_2F origin, Pointer<IDWriteTextLayout> textLayout, Pointer<ID2D1Brush> defaultForegroundBrush, ValuedEnum<D2D1_DRAW_TEXT_OPTIONS> options);
	
	@Virtual(25)
	public native void DrawGlyphRun(D2D1_POINT_2F baselineOrigin, Pointer<DWRITE_GLYPH_RUN> glyphRun, Pointer<ID2D1Brush> foregroundBrush, DWRITE_MEASURING_MODE measuringMode);
	...
	public ID2D1SolidColorBrush CreateSolidColorBrush(D2D1_COLOR_F color, D2D1_BRUSH_PROPERTIES brushProperties) {
		...
		try {
			int result = CreateSolidColorBrush(color != null ? pointerTo(color) : null, 
