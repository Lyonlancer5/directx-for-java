 ...
 */
@Library("d3d11") 
public class D3D11_TEXTURE1D_DESC extends StructObject {
	...
	@Field(0) 
	public D3D11_TEXTURE1D_DESC Width(int Width) {
	...
	@Field(1) 
	public D3D11_TEXTURE1D_DESC MipLevels(int MipLevels) {
	...
	@Field(2) 
	public D3D11_TEXTURE1D_DESC ArraySize(int ArraySize) {
	...
	/// C type : DXGI_FORMAT
	@Field(3) 
	public D3D11_TEXTURE1D_DESC Format(ValuedEnum<DXGI_FORMAT > Format) {
	...
	/// C type : D3D11_USAGE
	@Field(4) 
	public D3D11_TEXTURE1D_DESC Usage(ValuedEnum<D3D11_USAGE > Usage) {
	...
	@Field(5) 
	public D3D11_TEXTURE1D_DESC BindFlags(ValuedEnum<D3D11_BIND_FLAG> BindFlags) {
		this.io.setEnumField(this, 5, BindFlags);
		return this;
	}
	@Field(6) 
	...
	@Field(6) 
	public D3D11_TEXTURE1D_DESC CPUAccessFlags(int CPUAccessFlags) {
	...
	@Field(7) 
	public D3D11_TEXTURE1D_DESC MiscFlags(ValuedEnum<D3D11_RESOURCE_MISC_FLAG> MiscFlags) {
		this.io.setEnumField(this, 7, MiscFlags);
		return this;
	}
}
