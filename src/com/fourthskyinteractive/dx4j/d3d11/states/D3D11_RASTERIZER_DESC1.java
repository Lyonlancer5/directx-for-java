 ...
 */
@Library("d3d11") 
public class D3D11_RASTERIZER_DESC1 extends StructObject {
	public D3D11_RASTERIZER_DESC1() {
		super();
	}
	public D3D11_RASTERIZER_DESC1(Pointer<? extends StructObject> pointer) {
		super(pointer);
	}
	...
	/// C type : D3D11_FILL_MODE
	@Field(0) 
	public D3D11_RASTERIZER_DESC1 FillMode(ValuedEnum<D3D11_FILL_MODE > FillMode) {
	...
	/// C type : D3D11_CULL_MODE
	@Field(1) 
	public D3D11_RASTERIZER_DESC1 CullMode(ValuedEnum<D3D11_CULL_MODE > CullMode) {
	...
	@Field(2) 
	public D3D11_RASTERIZER_DESC1 FrontCounterClockwise(int FrontCounterClockwise) {
	...
	@Field(3) 
	public D3D11_RASTERIZER_DESC1 DepthBias(int DepthBias) {
	...
	@Field(4) 
	public D3D11_RASTERIZER_DESC1 DepthBiasClamp(float DepthBiasClamp) {
	...
	@Field(5) 
	public D3D11_RASTERIZER_DESC1 SlopeScaledDepthBias(float SlopeScaledDepthBias) {
	...
	@Field(6) 
	public D3D11_RASTERIZER_DESC1 DepthClipEnable(int DepthClipEnable) {
	...
	@Field(7) 
	public D3D11_RASTERIZER_DESC1 ScissorEnable(int ScissorEnable) {
	...
	@Field(8) 
	public D3D11_RASTERIZER_DESC1 MultisampleEnable(int MultisampleEnable) {
	...
	@Field(9) 
	public D3D11_RASTERIZER_DESC1 AntialiasedLineEnable(int AntialiasedLineEnable) {
	...
	@Field(10)
	public D3D11_RASTERIZER_DESC1 ForcedSampleCount(int forcedSampleCount) {
		this.io.setIntField(this, 10, forcedSampleCount);
		return this;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ForcedSampleCount();
