 ...
 */
@Library("d3d9") 
public class D3DINDEXBUFFER_DESC extends StructObject {
	public D3DINDEXBUFFER_DESC() {
		super();
	}
	public D3DINDEXBUFFER_DESC(Pointer<? extends StructObject> pointer) {
		super(pointer);
	}
	/// C type : D3DFORMAT
	@Field(0) 
	...
	/// C type : D3DFORMAT
	@Field(0) 
	public D3DINDEXBUFFER_DESC Format(ValuedEnum<D3DFORMAT > Format) {
	...
	/// C type : D3DRESOURCETYPE
	@Field(1) 
	public D3DINDEXBUFFER_DESC Type(ValuedEnum<D3DRESOURCETYPE > Type) {
	...
	@Field(2) 
	public D3DINDEXBUFFER_DESC Usage(int Usage) {
	...
	/// C type : D3DPOOL
	@Field(3) 
	public D3DINDEXBUFFER_DESC Pool(ValuedEnum<D3DPOOL > Pool) {
	...
	@Field(4) 
	public D3DINDEXBUFFER_DESC Size(int Size) {
